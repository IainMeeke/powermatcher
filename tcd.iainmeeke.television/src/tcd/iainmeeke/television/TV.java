package tcd.iainmeeke.television;
...
/**
 * {@link PVPanelAgent} is a implementation of a {@link BaseAgentEndpoint}. It represents a dummy television.
 ...
 * @version 2.0
 */
@Component(designateFactory = TV.Config.class,
           immediate = true,
...
public class TV
    ...
    public static interface Config {
        @Meta.AD(deflt = "TV", description = "The unique identifier of the agent")
        String agentId();
