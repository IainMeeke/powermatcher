...
/**
 * {@link PVPanelAgent} is a implementation of a {@link BaseAgentEndpoint}. It represents a dummy home lighting system.
 ...
 * @version 2.0
 */
@Component(designateFactory = Lights.Config.class,
           immediate = true,
...
public class Lights
    ...
    public static interface Config {
        @Meta.AD(deflt = "Lights", description = "The unique identifier of the agent")
        String agentId();
    ...
    public synchronized void handlePriceUpdate(PriceUpdate priceUpdate) {
        ...
        // Nothing to control for a Lights
    }
